<?php
/**
* Responsável por gerenciar e persisitir os dados de telefones dos Contatos da Agenda Telefônica
*/
class TelefoneModel extends PersistModelAbstract
{
    ...
    function __construct()
    {
        ...
        #executa o método de criação da tabela Telefone
    ...
    /**
    * Retorna um array contendo os telefones de um determinado contato
